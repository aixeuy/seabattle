...
public class Carrier extends Ship {
	...
	public Carrier(int j,String name) {
		switch(j){
		case 1:setship(name,11,22,11,"early",8);break;
		case 2:setship(name,14,28,14,"basic",7);break;
	...
	public Carrier(String type2,int j) {
		switch(j){
		case 1:setship(null,11,22,11,type2,8);break;
		case 2:setship(null,14,28,14,type2,7);break;
